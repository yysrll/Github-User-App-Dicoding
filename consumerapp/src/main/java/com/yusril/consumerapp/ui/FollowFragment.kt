...
import com.yusril.consumerapp.databinding.FragmentFollowBinding
import com.yusril.consumerapp.model.User
import com.yusril.consumerapp.viewmodel.FollowViewModel
...
class FollowFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val user = activity?.intent?.getParcelableExtra(DetailActivity.EXTRA_USER) as User
